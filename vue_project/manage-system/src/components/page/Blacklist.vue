<template>
    <div class="table">
        ...
        <el-table :data="searchData" 
            ...
            <el-table-column prop="count" sortable label="次数" width="90">
            </el-table-column>
...
<script>
    export default {
        data() {
            return {
                url: 'http://127.0.0.1:8081/admin/blacklist',
        ...
        methods: {
            ...
            //删除黑名单
            deleteBlacklist(idList) {
            //alert(idList);
            console.log(idList);
              this.$http({
                url: 'http://127.0.0.1:8081/admin/deleteBlacklist',
                method: 'get',
                params: {
