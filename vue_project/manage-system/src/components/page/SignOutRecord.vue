<template>
    <div class="table">
        ...
        <el-table :data="searchData" 
            ...
            <el-table-column prop="signOutTime" label="签离时间" width="170">
            </el-table-column>
            <el-table-column prop="signOutTypeName" label="签离类别" width="140">
            </el-table-column>
            <el-table-column
              prop="tag"
              label="标签"
...
<script>
    export default {
        data() {
            return {
                url: 'http://127.0.0.1:8081/admin/signOutRecord',
                tableData: [],
                tableDataShow: [],
                sels: [], //列表选中列
                listLoading: false,
